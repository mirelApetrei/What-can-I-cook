...
import com.example.whatcanicook.models.ExtendedIngredient
import com.example.whatcanicook.utils.Constants.Companion.BASE_IMAGE_URL
import com.example.whatcanicook.utils.RecipesDiffUtil
import java.util.*
...
//            holder.itemView.animate().alpha(1f).setDuration(600).start() // <-- this method is instead of crossfade()
